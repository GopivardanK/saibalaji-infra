    ...
    (r = function (e, t) {
                ...
                case "previous":
                    (n =
                        ...
                        s.slideCount > s.options.slidesToShow &&
                            s.slideHandler(s.currentSlide - n, !1, t);
                    break;
                case "next":
            ...
            return (
                ...
                !0 === s.options.swipeToSlide
                    ? (s.$slideTrack.find(".slick-slide").each(function (e, t) {
                          if (
                              t.offsetLeft - n + d(t).outerWidth() / 2 >
                              -1 * s.swipeLeft
                          )
                              return (i = t), !1;
                      }),
                      Math.abs(
                          d(i).attr("data-slick-index") - s.currentSlide
                      ) || 1)
                    : s.options.slidesToScroll
            );
        }),
        ...
        (r.prototype.refresh = function (e) {
            ...
            (i = n.slideCount - n.options.slidesToShow),
                ...
                n.init(),
                e ||
                    n.changeSlide({ data: { message: "index", index: t } }, !1);
        }),
                ...
                for (e in ((n.respondTo = n.options.respondTo || "window"), s))
                    if (((i = n.breakpoints.length - 1), s.hasOwnProperty(e))) {
                        ...
                        n.breakpoints.push(t),
                            (n.breakpointSettings[t] = s[e].settings);
                    }
            ...
            for (e = 0; e < o; e++)
                if (
                    ("object" == typeof n || void 0 === n
                        ...
                        : (t = i[e].slick[n].apply(i[e].slick, s)),
                    void 0 !== t)
                )
                    return t;
            return i;
    ...
    (e = function (c) {
        ...
        (e.prototype = {
            ...
            open: function (e) {
                ...
                if (!1 === e.isObj) {
                    ...
                    for (t = 0; t < n.length; t++)
                        if (
                            ((i = n[t]).parsed && (i = i.el[0]), i === e.el[0])
                        ) {
                            h.index = t;
                            break;
                        }
            ...
            updateItemHTML: function () {
                ...
                var t = e.type;
                if (
                    (_("BeforeChange", [h.currItem ? h.currItem.type : "", t]),
                    (h.currItem = e),
                    !h.currTemplate[t])
                ) {
            ...
            _onFocusIn: function (e) {
                return e.target === h.wrap[0] || c.contains(h.wrap[0], e.target)
                    ? void 0
                    : (h._setFocus(), !1);
            },
                        ...
                        if (n.length) {
                            ...
                            s &&
                                ...
                                (C ||
                                    ...
                                    (C = b(k)),
                                    (k = "mfp-" + k)),
                                (S = n.after(C).detach().removeClass(k))),
                    ...
                    var e = c.extend(
                        {
                            ...
                            error: function () {
                                I(),
                                    ...
                                    h.updateStatus(
                                        "error",
                                        h.st.ajax.tError.replace("%url%", s.src)
                                    );
                            },
                        },
                        h.st.ajax.settings
            ...
            proto: {
                ...
                _getOffset: function (e) {
                    ...
                    var o = {
                        width: t.width(),
                        height:
                            (a ? t.innerHeight() : t[0].offsetHeight) - s - n,
                    };
                    return (
                        void 0 === L &&
                            (L =
...
$("body").append('<div class="mm-fullscreen-bg"></div>'),
    ($.fn.initMM = function () {
        var n = {
            ...
            init: function (e, t) {
                ...
                null != t && i.parse_arguments(t),
                    i.$mobilemenu.parse_mm(n),
                    i.$mobilemenu.init_mm(n),
                    i.mm_enable_breakpoint &&
                        i.$mobilemenu.check_resolution_mm(n),
                    e.mm_handler(n);
            },
            parse_arguments: function (e) {
                var i = this;
                Object(e).hasOwnProperty("menu_class") &&
                    (i.$mobilemenu = $("." + e.menu_class)),
                    $.each(e, function (e, t) {
                        switch (e) {
                            case "right":
            ...
            show_button_in_mobile: function (e) {
                ...
                t.mm_mobile_button &&
                    ...
                    $(window).resize(function () {
                        window.innerWidth > t.mm_breakpoint
                            ? e.hide()
                            : e.show();
                    }));
            },
                        ...
                        0 == e
                            ? (l
                              ...
                              '<li class="mm-close-parent"><a href="#close" data-target="#close" class="mm-close">' +
                                  (n = null == n ? s : n) +
                                  "</a></li>")
                            : ((t = r.find(".mm-backbtn").html()),
                              (i = o.mm_back_button),
                              '<li><a href="#" data-target="#" class="mm-prev-level">' +
                                  (t = null == t ? i : t) +
                                  "</a></li>")),
                    l.find("ul").first().prepend(d),
                    a.append(l);
            }),
            $(this).append(a);
    }),
    ...
    ((m = y =
        function (e, t) {
            (this.el = e),
                (this.$el = r(e)),
                (this.opts = r.extend(!0, {}, g, t, this.$el.data())),
                c == o && (c = r("body")),
        ...
        init: function () {
            f ||
                ...
                this.opts.timepicker &&
                    ((this.timepicker = new r.fn.datepicker.Timepicker(
                        this,
                        this.opts
                    )),
                ...
                (this.views[this.currentView] = new r.fn.datepicker.Body(
                    this,
                    this.currentView,
                    this.opts
                )),
        ...
        _bindEvents: function () {
            this.$el.on(
                ...
                r(t).on("resize.adp", this._onResize.bind(this)),
        ...
        _defineLocale: function (e) {
                ...
                ? ((this.loc = r.fn.datepicker.language[e]),
                  this.loc ||
                      ...
                      (this.loc = r.extend(
                          !0,
                          {},
                          r.fn.datepicker.language.ru
                      ))),
                  (this.loc = r.extend(
                      !0,
                      {},
                      r.fn.datepicker.language.ru,
                      r.fn.datepicker.language[e]
                  )))
            ...
            (this.loc.timeFormat.match(t("aa")) ||
                this.loc.timeFormat.match(t("AA"))) &&
                (this.ampm = !0);
        },
        ...
        formatDate: function (e, t) {
            ...
            switch (
                (this.opts.timepicker &&
                    ...
                    h &&
                    ((d = r(
                        (i = this.timepicker._getValidHoursFromDate(t, h)).hours
                    )),
                    (c = i.hours),
                    (u = i.dayPeriod)),
                !0)
            ...
            if (Array.isArray(e))
                    ...
                    i.range
                        ? 2 == s
                            ...
                            ? (t.selectedDates.push(e),
                              ...
                              m.bigger(t.maxRange, t.minRange) &&
                                  ((t.maxRange = t.minRange), (t.minRange = e)),
                ...
                t._setInputValue(),
                    ...
                    i.autoClose &&
                        ...
                        (i.multipleDates || i.range
                            ? i.range && 2 == t.selectedDates.length && t.hide()
                            : t.hide()),
        ...
        update: function (e, t) {
            ...
            return (
                2 == i
                    ...
                    : 1 == i &&
                      "object" == typeof e &&
                      (this.opts = r.extend(!0, this.opts, e)),
                this._createShortCuts(),
                this._syncWithMinMaxDates(),
                this._defineLocale(this.opts.language),
                ...
                this.opts.onlyTimepicker &&
                    this.$datepicker.addClass("-only-timepicker-"),
                this.opts.timepicker &&
                    (n && this.timepicker._handleDate(n),
                    this.timepicker._updateRanges(),
                    this.timepicker._updateCurrentTime(),
                    n &&
                        (n.setHours(this.timepicker.hours),
                        n.setMinutes(this.timepicker.minutes))),
                this._setInputValue(),
                this
            );
        },
        ...
        _setPositionClasses: function (e) {
            ...
            this.visible && (i += " active"),
                this.$datepicker.removeAttr("class").addClass(i);
        },
        setPosition: function (e) {
            ...
            switch (l) {
                ...
                case "center":
                    /left|right/.test(a)
                        ? (t = n.top + n.height / 2 - s.height / 2)
                        : (i = n.left + n.width / 2 - s.width / 2);
            }
        ...
        _focusNextCell: function (e, t) {
            ...
            if (!this._isHotKeyPressed()) {
                ...
                r.getTime() < this.minTime
                    ? (r = this.minDate)
                    : r.getTime() > this.maxTime && (r = this.maxDate),
                    (this.focused = r);
            }
        },
        ...
        _getCell: function (e, t) {
            ...
            return (i = this.views[this.currentView].$el.find(s)).length
                ? i
                : r("");
        },
        destroy: function () {
            ...
            e.$el.off(".adp").data("datepicker", ""),
                ...
                (e.minRange = ""),
                (e.maxRange = ""),
                e.opts.inline || !e.elIsInput
                    ? e.$datepicker.closest(".datepicker-inline").remove()
                    : e.$datepicker.remove();
        },
            ...
            this.opts.range
                ? this.opts.toggleSelected
                    ...
                    : 2 != this.selectedDates.length &&
                      this._trigger("clickCell", t)
                : this.opts.toggleSelected && this.removeDate(t),
                this.opts.toggleSelected ||
                    ((this.lastSelectedDate = e),
                    this.opts.timepicker &&
                        (this.timepicker._setTime(e),
        ...
        _onMouseUpDatepicker: function (e) {
            (this.inFocus = !1),
                (e.originalEvent.inFocus = !0),
                e.originalEvent.timepickerFocus || this.$el.focus();
        },
        ...
        _onKeyDown: function (e) {
            ...
            if (
                ...
                37 <= t &&
                    t <= 40 &&
                    (e.preventDefault(), this._focusNextCell(t)),
                13 == t && this.focused)
            ) {
        ...
        _onMouseEnterCell: function (e) {
            ...
            (this.silent = !0),
                ...
                this.opts.range &&
                    ...
                    (this.maxRange = ""),
                    m.less(this.minRange, this.focused) &&
                        ((this.maxRange = this.minRange), (this.minRange = "")),
                    this.views[this.currentView]._update());
        },
        _onMouseLeaveCell: function (e) {
            r(e.target).closest(".datepicker--cell").removeClass("-focus-"),
                (this.silent = !0),
                (this.focused = ""),
                (this.silent = !1);
        },
        _onTimeChange: function (e, t, i) {
            ...
            this.selectedDates.length &&
                ((s = !0), (n = this.lastSelectedDate)),
                n.setHours(t),
                n.setMinutes(i),
                s || this._getCell(n).hasClass("-disabled-")
                    ? (this._setInputValue(),
                      this.opts.onSelect && this._triggerOnChange())
                    : this.selectDate(n);
        },
        ...
        set focused(e) {
            ...
            (this._focused = e),
                this.opts.range &&
                    ...
                    ((this.minRange = this.selectedDates[0]),
                    (this.maxRange = ""),
                    m.less(this.minRange, this._focused) &&
            ...
            return (
                ...
                this.viewIndex < 0
                    ...
                    : ((this.prevView = this.currentView),
                      ...
                      this.inited &&
                          (this.views[e]
                              ? this.views[e]._render()
                              : (this.views[e] = new r.fn.datepicker.Body(
                                    this,
                                    e,
                                    this.opts
                                )),
    ...
    (m.resetTime = function (e) {
        return "object" == typeof e
            ? ((e = m.getParsedDate(e)), new Date(e.year, e.month, e.date))
            : void 0;
    }),
    ...
    (d.Body.prototype = {
        ...
        _bindEvents: function () {
            this.$el.on(
                "click",
                ".datepicker--cell",
                r.proxy(this._onClickCell, this)
            );
        },
        _buildBaseHtml: function () {
            (this.$el = r(l[this.type]).appendTo(this.d.$content)),
                (this.$names = r(".datepicker--days-names", this.$el)),
            ...
            return (
                ...
                7 < (n = n != o ? n : 0)
                    ...
                    : ((i +=
                          ...
                          (this.d.isWeekend(t) ? " -weekend-" : "") +
                          '">' +
                          this.d.loc.daysMin[t] +
                          "</div>"),
                      this._getDayNamesHtml(e, ++t, i, ++n))
            );
        },
        _getCellContents: function (e, t) {
            ...
            switch (t) {
                case "day":
                    s.isWeekend(l.day) && (i += " -weekend-"),
                        l.month != this.d.parsedDate.month &&
                            ((i += " -other-month-"),
                            a.selectOtherMonths || (i += " -disabled-"),
                            a.showOtherMonths || (c = ""));
                    break;
                case "month":
                ...
                case "year":
                    var h = s.curDecade;
                    (c = l.year),
                        (l.year < h[0] || l.year > h[1]) &&
                            ((i += " -other-decade-"),
                            a.selectOtherYears || (i += " -disabled-"),
                            a.showOtherYears || (c = ""));
            }
            return (
                a.onRenderCell &&
                    ((c = (d = a.onRenderCell(e, t) || {}).html ? d.html : c),
                    (i += d.classes ? " " + d.classes : "")),
                a.range &&
                    (u.isSame(o, e, t) && (i += " -range-from-"),
                    u.isSame(r, e, t) && (i += " -range-to-"),
                    1 == s.selectedDates.length && s.focused
                        ? (((u.bigger(o, e) && u.less(s.focused, e)) ||
                              (u.less(r, e) && u.bigger(s.focused, e))) &&
                              (i += " -in-range-"),
                          u.less(r, e) &&
                              u.isSame(s.focused, e) &&
                              (i += " -range-from-"),
                          u.bigger(o, e) &&
                              u.isSame(s.focused, e) &&
                              (i += " -range-to-"))
                        : 2 == s.selectedDates.length &&
                          u.bigger(o, e) &&
                          u.less(r, e) &&
                          (i += " -in-range-")),
                u.isSame(n, e, t) && (i += " -current-"),
                s.focused && u.isSame(e, s.focused, t) && (i += " -focus-"),
                s._isSelected(e, t) && (i += " -selected-"),
                (!s._isInRange(e, t) || d.disabled) && (i += " -disabled-"),
                { html: c, classes: i }
            );
        },
        _getDaysHtml: function (e) {
            for (
                ...
                (i = e.getFullYear()),
                    (t = e.getMonth()),
                    (l += this._getDayHtml(new Date(i, t, d)));
            return l;
        },
        ...
        _getMonthsHtml: function (e) {
            for (var t = "", i = u.getParsedDate(e), n = 0; n < 12; )
        ...
        _getYearsHtml: function (e) {
            for (
                var t = (u.getParsedDate(e), u.getDecade(e)),
                    i = "",
                    n = t[0] - 1;
                n <= t[1] + 1;
                n++
        ...
        _update: function () {
            ...
            e.each(function (e, t) {
                (n = r(this)),
                    (s = o.d._getDateFromCell(r(this))),
                    (i = o._getCellContents(s, o.d.cellType)),
                    n.attr("class", i.classes);
            });
        },
        show: function () {
            this.opts.onlyTimepicker ||
        ...
        _handleClick: function (e) {
            ...
            if (s.view == this.opts.minView) {
                ...
                return r
                    ? void s._handleAlreadySelectedDates.bind(s, r, o)()
                    : void s._trigger("clickCell", o);
            }
    ...
    (n.Navigation.prototype = {
        ...
        _bindEvents: function () {
            this.d.$nav.on(
                ...
                r.proxy(this._onClickNavButton, this)
            ),
                this.d.$nav.on(
                    "click",
                    ".datepicker--nav-title",
                    r.proxy(this._onClickNavTitle, this)
                ),
        ...
        _render: function () {
            ...
            this.d.$nav.html(t),
                "years" == this.d.view &&
                    r(".datepicker--nav-title", this.d.$nav).addClass(
                        "-disabled-"
                    ),
                this.setNavStatus();
        },
        ...
        _addButton: function (e) {
            ...
            r("[data-action=" + e + "]", this.$buttonsContainer).length ||
        ...
        setNavStatus: function () {
            if (
                ...
                switch (this.d.view) {
                    case "days":
                        this.d._isInRange(new Date(i, t - 1, 1), "month") ||
                            this._disableNav("prev"),
                            this.d._isInRange(new Date(i, t + 1, 1), "month") ||
                                this._disableNav("next");
                        break;
                    case "months":
                        this.d._isInRange(new Date(i - 1, t, n), "year") ||
                            this._disableNav("prev"),
                            this.d._isInRange(new Date(i + 1, t, n), "year") ||
                                this._disableNav("next");
                        break;
                    case "years":
                        ...
                        this.d._isInRange(new Date(s[0] - 1, 0, 1), "year") ||
                            this._disableNav("prev"),
                            this.d._isInRange(
                                new Date(s[1] + 1, 0, 1),
                                "year"
        ...
        _activateNav: function (e) {
            r('[data-action="' + e + '"]', this.d.$nav).removeClass(
                "-disabled-"
            );
        },
        ...
        _onClickNavTitle: function (e) {
            return r(e.target).hasClass("-disabled-")
                ? void 0
                : "days" == this.d.view
                ? (this.d.view = "months")
    ...
    (i.Timepicker.prototype = {
        ...
        _setTime: function (e) {
            ...
            this._handleDate(e),
                (this.hours =
                    t.hours < this.minHours ? this.minHours : t.hours),
                (this.minutes =
                    t.minutes < this.minMinutes ? this.minMinutes : t.minutes);
        },
        _setMinTimeFromDate: function (e) {
            (this.minHours = e.getHours()),
                (this.minMinutes = e.getMinutes()),
                this.d.lastSelectedDate &&
                    this.d.lastSelectedDate.getHours() > e.getHours() &&
        ...
        _setDefaultMinMaxTime: function () {
            var e = this.opts;
            (this.minHours =
                e.minHours < 0 || 23 < e.minHours ? 0 : e.minHours),
                (this.minMinutes =
                    e.minMinutes < 0 || 59 < e.minMinutes ? 0 : e.minMinutes),
                (this.maxHours =
                    e.maxHours < 0 || 23 < e.maxHours ? 23 : e.maxHours),
                (this.maxMinutes =
                    e.maxMinutes < 0 || 59 < e.maxMinutes ? 59 : e.maxMinutes);
        },
            ...
            (this.$timepicker = r(i).appendTo(this.d.$datepicker)),
                ...
                this.d.ampm &&
                    ((this.$ampm = r(
                        ...
                        .appendTo(
                            r(".datepicker--time-current", this.$timepicker)
                        )
                        .html(this.dayPeriod)),
        ...
        _updateCurrentTime: function () {
            ...
            this.$hoursText.html(e),
                this.$minutesText.html(t),
        ...
        _handleDate: function (e) {
            this._setDefaultMinMaxTime(),
                e &&
                    (s.isSame(e, this.d.opts.minDate)
                        ? this._setMinTimeFromDate(this.d.opts.minDate)
                        : s.isSame(e, this.d.opts.maxDate) &&
        ...
        _onMouseEnterRange: function (e) {
            ...
            r(".datepicker--time-current-" + t, this.$timepicker).addClass(
                "-focus-"
            );
        },
    ...
    })(
        {
                ...
                function (e, t, i) {
                    ...
                    (i.add = function (e, t) {
                        ...
                        e.classList
                            ? e.classList.add(t)
                            : ((n = t),
                              (s = (i = e).className.split(" ")).indexOf(n) <
                                  0 && s.push(n),
                              (i.className = s.join(" ")));
                    }),
                        (i.remove = function (e, t) {
                            ...
                            e.classList
                                ...
                                : ((n = t),
                                  (s = (i = e).className.split(" ")),
                                  0 <= (o = s.indexOf(n)) && s.splice(o, 1),
                                  (i.className = s.join(" ")));
                        }),
                        (i.list = function (e) {
                            return e.classList
                ...
                function (e, t, i) {
                    ...
                    (i.toInt = function (e) {
                        ...
                        (i.outerWidth = function (e) {
                            return (
                                this.toInt(n.css(e, "width")) +
                                this.toInt(n.css(e, "paddingLeft")) +
                                this.toInt(n.css(e, "paddingRight")) +
                                this.toInt(n.css(e, "borderLeftWidth")) +
                                this.toInt(n.css(e, "borderRightWidth"))
                            );
                        }),
                ...
                function (e, t, i) {
                    ...
                    t.exports = function (e) {
                        !(function (n, s) {
                            ...
                            s.settings.stopPropagationOnClick &&
                                s.event.bind(s.scrollbarY, "click", e),
                                s.event.bind(
                                    s.scrollbarYRail,
                                    "click",
                                    function (e) {
                                ...
                                s.settings.stopPropagationOnClick &&
                                    s.event.bind(s.scrollbarX, "click", e),
                                s.event.bind(
                                    s.scrollbarXRail,
                                    "click",
                                    function (e) {
                ...
                function (e, t, i) {
                    ...
                    function s(s, o) {
                        ...
                        o.event.bind(o.scrollbarX, "mousedown", function (e) {
                            (t = e.pageX),
                                (r =
                                    l.toInt(a.css(o.scrollbarX, "left")) *
                                    o.railXRatio),
                    ...
                    function o(s, o) {
                        ...
                        o.event.bind(o.scrollbarY, "mousedown", function (e) {
                            (t = e.pageY),
                                (r =
                                    l.toInt(a.css(o.scrollbarY, "top")) *
                                    o.railYRatio),
                        ...
                        r.event.bind(r.ownerDocument, "keydown", function (e) {
                            if (
                                ...
                                if (a || t) {
                                    ...
                                    h(o, "top", o.scrollTop - s),
                                        h(o, "left", o.scrollLeft + n),
                                        c(o),
                                        (function (e, t) {
                                            var i = o.scrollTop;
                                            if (0 === e) {
                            ...
                            (function (e, t) {
                                ...
                                l.settings.useBothWheelAxes
                                    ...
                                    : (h(
                                          ...
                                          "top",
                                          a.scrollTop -
                                              r * l.settings.wheelSpeed
                                      ),
                                      h(
                                          a,
                                          "left",
                                          a.scrollLeft +
                                              o * l.settings.wheelSpeed
                                      )),
                                c(a),
                                (d =
                                    d ||
            ...
            16: [
                function (e, t, i) {
                    ...
                    function n(a, l, e, t) {
                        function d(e, t) {
                            b(a, "top", a.scrollTop - t),
                                b(a, "left", a.scrollLeft - e),
                                w(a);
                        }
                        var c = {},
                            h = 0,
                        ...
                        e &&
                            ...
                            l.event.bind(window, "touchend", s),
                            ...
                            t &&
                                (window.PointerEvent
                                    ? (l.event.bind(window, "pointerdown", n),
                                      l.event.bind(window, "pointerup", s),
                                    ...
                                    : window.MSPointerEvent &&
                                      ...
                                      l.event.bind(window, "MSPointerUp", s),
                ...
                function (e, t, i) {
                    ...
                    t.exports = function (e, t) {
                        ...
                        (i.settings = s.extend(i.settings, t)),
                            ...
                            c(e),
                            h(e),
                            i.settings.useSelectionScroll && u(e),
                            (s.env.supportsTouch || s.env.supportsIePointer) &&
                                p(
                                    e,
                                    s.env.supportsTouch,
                                    s.env.supportsIePointer
                                ),
                            i.settings.useKeyboard && d(e),
                            r(e);
                    };
                },
                {
                ...
                function (e, t, i) {
                    ...
                    function h(e) {
                        ...
                        (n.settings = c.clone(l)),
                            ...
                            (n.scrollbarXBottom = c.toInt(
                                a.css(n.scrollbarXRail, "bottom")
                            )),
                            ...
                            (n.railBorderXWidth =
                                c.toInt(
                                    a.css(n.scrollbarXRail, "borderLeftWidth")
                                ) +
                                c.toInt(
                                    a.css(n.scrollbarXRail, "borderRightWidth")
                                )),
                            a.css(n.scrollbarXRail, "display", "block"),
                            (n.railXMarginWidth =
                                c.toInt(a.css(n.scrollbarXRail, "marginLeft")) +
                                c.toInt(
                                    a.css(n.scrollbarXRail, "marginRight")
                                )),
                            ...
                            (n.scrollbarYRight = c.toInt(
                                a.css(n.scrollbarYRail, "right")
                            )),
                            ...
                            (n.railBorderYWidth =
                                c.toInt(
                                    a.css(n.scrollbarYRail, "borderTopWidth")
                                ) +
                                c.toInt(
                                    a.css(n.scrollbarYRail, "borderBottomWidth")
                                )),
                            a.css(n.scrollbarYRail, "display", "block"),
                            (n.railYMarginHeight =
                                c.toInt(a.css(n.scrollbarYRail, "marginTop")) +
                                c.toInt(
                                    a.css(n.scrollbarYRail, "marginBottom")
                                )),
            ...
            20: [
                function (e, t, i) {
                    ...
                    a.initEvent("ps-scroll-up", !0, !0),
                        ...
                        m.initEvent("ps-x-reach-end", !0, !0),
                        ...
                        (t.exports = function (e, t, i) {
                            ...
                            "top" === t &&
                                i <= 0 &&
                                ((e.scrollTop = i = 0), e.dispatchEvent(f)),
                                "left" === t &&
                                    i <= 0 &&
                                    ((e.scrollLeft = i = 0),
                                    e.dispatchEvent(p));
                            ...
                            "top" === t &&
                                ...
                                "left" === t && i < o && e.dispatchEvent(d),
                                "left" === t && o < i && e.dispatchEvent(c),
                                "top" === t &&
                                    ((e.scrollTop = s = i), e.dispatchEvent(h)),
                                "left" === t &&
                                    ((e.scrollLeft = o = i),
                                    e.dispatchEvent(u));
                        });
                ...
                function (e, t, i) {
                    ...
                    t.exports = function (e) {
                        ...
                        t &&
                            ...
                            (t.railXMarginWidth =
                                s.toInt(n.css(t.scrollbarXRail, "marginLeft")) +
                                s.toInt(
                                    n.css(t.scrollbarXRail, "marginRight")
                                )),
                            (t.railYMarginHeight =
                                s.toInt(n.css(t.scrollbarYRail, "marginTop")) +
                                s.toInt(
                                    n.css(t.scrollbarYRail, "marginBottom")
                                )),
    ...
    (b = {
        init: function (e, t) {
            ...
            (i.elem = t),
                ...
                (i.imageSrc = i.$elem.data("zoom-image")
                    ...
                    : i.$elem.attr("src")),
                (i.options = w.extend({}, w.fn.elevateZoom.options, e)),
                i.options.tint &&
                ...
                i.refresh(1),
                w("#" + i.options.gallery + " a").click(function (e) {
                    return (
                        i.options.galleryActiveClass &&
                            (w("#" + i.options.gallery + " a").removeClass(
                                i.options.galleryActiveClass
                            ),
                            w(this).addClass(i.options.galleryActiveClass)),
                        e.preventDefault(),
                        w(this).data("zoom-image")
                            ? (i.zoomImagePre = w(this).data("zoom-image"))
                            : (i.zoomImagePre = w(this).data("image")),
                        i.swaptheimage(w(this).data("image"), i.zoomImagePre),
                        !1
                    );
                });
        },
        ...
        startZoom: function () {
            ...
            "window" == i.options.zoomType &&
                ...
                i.options.showLens &&
                    (i.zoomLens.bind("touchmove", function (e) {
                        e.preventDefault(),
                            i.setPosition(
                                e.originalEvent.touches[0] ||
                                    e.originalEvent.changedTouches[0]
                ...
                i.$elem.bind("mousemove", function (e) {
                    0 == i.overWindow && i.setElements("show"),
                        (i.lastX === e.clientX && i.lastY === e.clientY) ||
                            (i.setPosition(e), (i.currentLoc = e)),
                        (i.lastX = e.clientX),
                        (i.lastY = e.clientY);
                }),
                ...
                "inner" != i.options.zoomType &&
                    i.zoomLens.bind("mousemove", function (e) {
                        (i.lastX === e.clientX && i.lastY === e.clientY) ||
                            (i.setPosition(e), (i.currentLoc = e)),
                            (i.lastX = e.clientX),
                            (i.lastY = e.clientY);
                ...
                i.options.tint &&
                    "inner" != i.options.zoomType &&
                    i.zoomTint.bind("mousemove", function (e) {
                        (i.lastX === e.clientX && i.lastY === e.clientY) ||
                            (i.setPosition(e), (i.currentLoc = e)),
                            (i.lastX = e.clientX),
                            (i.lastY = e.clientY);
                ...
                "inner" == i.options.zoomType &&
                    i.zoomWindow.bind("mousemove", function (e) {
                        (i.lastX === e.clientX && i.lastY === e.clientY) ||
                            (i.setPosition(e), (i.currentLoc = e)),
                            (i.lastX = e.clientX),
                            (i.lastY = e.clientY);
                ...
                i.options.scrollZoom &&
                    i.zoomContainer
                        ...
                        .bind(
                            ...
                            function (e) {
                                (i.scrollLock = !0),
                                    clearTimeout(w.data(this, "timer")),
                                    w.data(
                                        this,
                                        "timer",
                                        setTimeout(function () {
        ...
        setPosition: function (e) {
            ...
            (this.nzHeight = this.$elem.height()),
                ...
                "window" == this.options.zoomType &&
                    ...
                    (this.Eloppos =
                        this.mouseLeft < 0 + this.zoomLens.width() / 2),
                    (this.Eroppos =
                        this.mouseLeft >
                        this.nzWidth -
                ...
                "inner" == this.options.zoomType &&
                    ...
                    (this.Eloppos =
                        this.mouseLeft <
                        0 + this.nzWidth / 2 / this.widthRatio),
                    (this.Eroppos =
                        this.mouseLeft >
                        this.nzWidth -
                    ...
                    : (this.options.showLens &&
                      ...
                      "lens" == this.options.zoomType &&
                          ((this.windowLeftPos = String(
                              -1 *
                                  ((e.pageX - this.nzOffset.left) *
                                      this.widthRatio -
                                      this.zoomLens.width() / 2)
                          )),
                          (this.windowTopPos = String(
                              -1 *
                                  ((e.pageY - this.nzOffset.top) *
                                      this.heightRatio -
                                      this.zoomLens.height() / 2)
                          )),
                          this.zoomLens.css({
        ...
        setWindowPostition: function (e) {
            ...
            if (isNaN(t.options.zoomWindowPosition))
                (t.externalContainer = w("#" + t.options.zoomWindowPosition)),
            ...
            (t.isWindowSet = !0),
                ...
                "inner" == t.options.zoomType &&
                    (t.zoomWindow.css({ top: 0 }),
                    t.zoomWindow.css({ left: 0 })),
                                  ...
                                  (t.xp +=
                                      ...
                                      t.scrollingLock
                                          ? (clearInterval(t.loop),
                                            ...
                                            (t.xp =
                                                -1 *
                                                ((e.pageX - t.nzOffset.left) *
                                                    t.widthRatio -
                                                    t.zoomWindow.width() / 2)),
                                            (t.yp =
                                                -1 *
                                                ((e.pageY - t.nzOffset.top) *
                                                    t.heightRatio -
                                                    t.zoomWindow.height() / 2)),
                                            t.changeBgSize &&
        ...
        swapAction: function (e, t) {
            ...
            if (
                ...
                "lens" == i.options.zoomType &&
                    i.zoomLens.css({ backgroundImage: "url('" + t + "')" }),
                "window" == i.options.zoomType &&
                    i.zoomWindow.css({ backgroundImage: "url('" + t + "')" }),
                "inner" == i.options.zoomType &&
                    i.zoomWindow.css({ backgroundImage: "url('" + t + "')" }),
                (i.currentImage = t),
                i.options.imageCrossfade)
                ...
                i.$elem.attr("src", e),
                    i.$elem.after(o),
                    o.stop(!0).fadeOut(i.options.imageCrossfade, function () {
                        w(this).remove();
                    }),
                    ...
                    i.options.tint &&
                        "inner" != i.options.zoomType &&
                        ((o = (s = i.zoomTintImage).clone()),
                        i.zoomTintImage.attr("src", t),
                        i.zoomTintImage.after(o),
                        o
                            .stop(!0)
        ...
        getGalleryList: function () {
            ...
            return (
                (t.gallerylist = []),
                t.options.gallery
                    ? w("#" + t.options.gallery + " a").each(function () {
                          var e = "";
                          w(this).data("zoom-image")
                              ? (e = w(this).data("zoom-image"))
                              : w(this).data("image") &&
                                (e = w(this).data("image")),
                              e == t.zoomImage
        ...
        changeZoomLevel: function (e) {
            (this.scrollingLock = !0),
                ...
                (maxwidthtnewvalue =
                    this.largeWidth /
                    ((this.options.zoomWindowWidth / this.nzWidth) *
                        this.nzWidth)),
                "inner" != this.options.zoomType &&
    ...
    (_ = "undefined" != typeof window ? window : this),
    (T = function () {
        function e() {}
        var t = e.prototype;
        return (
    ...
    (C = function (e, t, c) {
        ...
        var s,
            ...
            Rt =
                    ...
                    getSelectorFromElement: function (e) {
                        ...
                        (i && "#" !== i) || (i = e.getAttribute("href") || ""),
                            "#" === i.charAt(0) &&
                                ((t = i),
                                (i = t =
                                    "function" == typeof Ot.escapeSelector
                                        ? Ot.escapeSelector(t).substr(1)
                                        : t.replace(
                                              /(:|\.|\[|\]|,|=|@)/g,
                                              "\\$1"
                                          )));
                ...
                (Ot.fn.emulateTransitionEnd = function (e) {
                    var t = this,
                        i = !1;
                    return (
                        Ot(this).one(Mt.TRANSITION_END, function () {
                            i = !0;
                        }),
                        setTimeout(function () {
                ...
                Mt.supportsTransitionEnd() &&
                    (Ot.event.special[Mt.TRANSITION_END] = {
                        bindType: Pt.end,
                        delegateType: Pt.end,
                        handle: function (e) {
            ...
            jt =
                    ...
                    return (
                        ...
                        (e._removeElement = function (t) {
                            ...
                            s(t).removeClass("show"),
                                Rt.supportsTransitionEnd() &&
                                s(t).hasClass("fade")
                                    ? s(t)
                                          .one(Rt.TRANSITION_END, function (e) {
                ...
                (s.fn[i] = u._jQueryInterface),
                (s.fn[i].Constructor = u),
            ...
            Nt =
                ...
                (T = (function () {
                    ...
                    return (
                                ...
                                if (n) {
                                    ...
                                    if (e) {
                                        if (
                                            ...
                                            return;
                                        (n.checked = !p(this._element).hasClass(
                                            w
                                        )),
                                            p(n).trigger("change");
                                    }
                        ...
                        (e.dispose = function () {
                            p.removeData(this._element, f),
                                (this._element = null);
                        }),
                        (i._jQueryInterface = function (t) {
                            return this.each(function () {
                                var e = p(this).data(f);
                                e || ((e = new i(this)), p(this).data(f, e)),
                                    "toggle" === t && e[t]();
                            });
                        }),
                        r(i, null, [
                ...
                (p.fn[m] = T._jQueryInterface),
                (p.fn[m].Constructor = T),
            ...
            Bt =
                ...
                ($t = (function () {
                    function o(e, t) {
                        (this._items = null),
                            ...
                            (this._indicatorsElement = yt(this._element).find(
                                Lt
                            )[0]),
                    ...
                    return (
                        ...
                        (e.nextWhenVisible = function () {
                            !document.hidden &&
                                ...
                                "hidden" !==
                                    yt(this._element).css("visibility") &&
                                this.next();
                        }),
                        (e.prev = function () {
                        ...
                        (e.pause = function (e) {
                            e || (this._isPaused = !0),
                                yt(this._element).find(Wt)[0] &&
                                    Rt.supportsTransitionEnd() &&
                                    (Rt.triggerTransitionEnd(this._element),
                                    this.cycle(!0)),
                        ...
                        (e.to = function (e) {
                            ...
                            if (!(e > this._items.length - 1 || e < 0))
                                if (this._isSliding)
                                    yt(this._element).one(xt.SLID, function () {
                                        return t.to(e);
                                    });
                                else {
                                    if (i === e)
                        ...
                        (e.dispose = function () {
                            yt(this._element).off(_t),
                                yt.removeData(this._element, bt),
                                (this._items = null),
                                (this._config = null),
                                (this._element = null),
                                (this._interval = null),
                        ...
                        (e._addEventListeners = function () {
                            ...
                            this._config.keyboard &&
                                yt(this._element).on(xt.KEYDOWN, function (e) {
                                    return t._keydown(e);
                                }),
                                "hover" === this._config.pause &&
                                    (yt(this._element)
                                        .on(xt.MOUSEENTER, function (e) {
                                            return t.pause(e);
                                        })
                            ...
                            if (
                                ...
                                yt(this._element).hasClass("slide")
                                    ? (yt(l).addClass(n),
                                      ...
                                      yt(l).addClass(i),
                                      yt(r)
                                          .one(Rt.TRANSITION_END, function () {
                                              yt(l)
                                                  .removeClass(i + " " + n)
                                                  .addClass(Et),
                                                  yt(r).removeClass(
                        ...
                        (o._dataApiClickHandler = function (e) {
                            ...
                            if (t) {
                                ...
                                if (i && yt(i).hasClass("carousel")) {
                                    ...
                                    s && (n.interval = !1),
                                        o._jQueryInterface.call(yt(i), n),
                                        s && yt(i).data(bt).to(s),
                                        e.preventDefault();
                                }
                            }
                ...
                yt(document).on(xt.CLICK_DATA_API, Ft, $t._dataApiClickHandler),
                yt(window).on(xt.LOAD_DATA_API, function () {
                    yt(Ht).each(function () {
                        var e = yt(this);
                        $t._jQueryInterface.call(e, e.data());
                    });
                }),
                (yt.fn[wt] = $t._jQueryInterface),
                (yt.fn[wt].Constructor = $t),
                (yt.fn[wt].noConflict = function () {
            ...
            Yt =
                ...
                (vt = (function () {
                    function a(e, t) {
                        (this._isTransitioning = !1),
                            (this._element = e),
                            (this._config = this._getConfig(t)),
                            (this._triggerArray = nt.makeArray(
                                nt(
                    ...
                    return (
                        ...
                        (e.show = function () {
                            ...
                            if (
                                ...
                                if (
                                    (nt(this._element).trigger(n),
                                    !n.isDefaultPrevented())
                                ) {
                                    e &&
                                        (a._jQueryInterface.call(
                                            nt(e).not(this._selector),
                                            "hide"
                                        ),
                                        t || nt(e).data(ot, null));
                                    ...
                                    var o = function () {
                                        nt(i._element)
                                            ...
                                            nt(i._element).trigger(ct.SHOWN);
                                    };
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    if (
                                        ...
                                        for (
                                            var n = 0;
                                            n < this._triggerArray.length;
                                            n++
                                        ) {
                                            var s = this._triggerArray[n],
                                                o =
                                                    Rt.getSelectorFromElement(
                                                        s
                                                    );
                                            null !== o &&
                                                (nt(o).hasClass(ht) ||
                        ...
                        (e.dispose = function () {
                            nt.removeData(this._element, ot),
                                (this._config = null),
                                (this._parent = null),
                                (this._element = null),
                        ...
                        (e._getConfig = function (e) {
                            return (
                                ((e = h({}, lt, e)).toggle = Boolean(e.toggle)),
                                Rt.typeCheckConfig(st, e, dt),
                                e
                            );
                        }),
                        (e._getDimension = function () {
                            return nt(this._element).hasClass("width")
                                ? "width"
                                : "height";
                        }),
                        (e._getParent = function () {
                            var i = this,
                                e = null;
                            Rt.isElement(this._config.parent)
                                ? ((e = this._config.parent),
                                  void 0 !== this._config.parent.jquery &&
                                      (e = this._config.parent[0]))
                                : (e = nt(this._config.parent)[0]);
                            var t =
                ...
                (nt.fn[st] = vt._jQueryInterface),
                (nt.fn[st].Constructor = vt),
                (nt.fn[st].noConflict = function () {
            ...
            Xt =
                ...
                (it = (function () {
                    ...
                    return (
                                ...
                                if ((l._clearMenus(), !t)) {
                                    ...
                                    if (
                                        ...
                                        if (!this._inNavbar) {
                                            ...
                                            var s = this._element;
                                            je(e).hasClass("dropup") &&
                                                (je(this._menu).hasClass(
                                                    "dropdown-menu-left"
                                                ) ||
                                                    je(this._menu).hasClass(
                                                        Ze
                                        ...
                                        "ontouchstart" in
                                            document.documentElement &&
                                            0 ===
                                                je(e).closest(".navbar-nav")
                                                    .length &&
                                            je("body")
                                                .children()
                                                .on("mouseover", null, je.noop),
                                            this._element.focus(),
                                            this._element.setAttribute(
                                                "aria-expanded",
                                                !0
                                            ),
                                            je(this._menu).toggleClass(Ke),
                                            je(e)
                                                .toggleClass(Ke)
                                                .trigger(je.Event(Ve.SHOWN, i));
                                    }
                                }
                            }
                        }),
                        (e.dispose = function () {
                            je.removeData(this._element, Be),
                                je(this._element).off(Ye),
                                (this._element = null),
                        ...
                        (e._detectNavbar = function () {
                            return (
                                0 < je(this._element).closest(".navbar").length
                            );
                        }),
                                ...
                                (/input|textarea/i.test(e.target.tagName)
                                    ? !(
                                          ...
                                          (27 !== e.which &&
                                              ((40 !== e.which &&
                                                  38 !== e.which) ||
                                                  je(e.target).closest(Je)
                                                      .length))
                                      )
                                    : Ue.test(e.which)) &&
                                (e.preventDefault(),
                                e.stopPropagation(),
                                !this.disabled && !je(this).hasClass(Qe))
                            ) {
                ...
                je(document)
                    .on(Ve.KEYDOWN_DATA_API, Ge, it._dataApiKeydownHandler)
                    .on(Ve.KEYDOWN_DATA_API, Je, it._dataApiKeydownHandler)
                    .on(
                        Ve.CLICK_DATA_API + " " + Ve.KEYUP_DATA_API,
                        it._clearMenus
                    )
                    .on(Ve.CLICK_DATA_API, Ge, function (e) {
                        e.preventDefault(),
                            e.stopPropagation(),
                            it._jQueryInterface.call(je(this), "toggle");
                    })
                    .on(Ve.CLICK_DATA_API, ".dropdown form", function (e) {
                        e.stopPropagation();
                    }),
                (je.fn[Ne] = it._jQueryInterface),
                (je.fn[Ne].Constructor = it),
                (je.fn[Ne].noConflict = function () {
            ...
            qt =
                    ...
                    return (
                        ...
                        (e.show = function (e) {
                            ...
                            if (!this._isTransitioning && !this._isShown) {
                                Rt.supportsTransitionEnd() &&
                                    Ce(this._element).hasClass(We) &&
                                    (this._isTransitioning = !0);
                                var i = Ce.Event(Ie.SHOW, { relatedTarget: e });
                                Ce(this._element).trigger(i),
                                    this._isShown ||
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    n && (this._isTransitioning = !0),
                                        this._setEscapeEvent(),
                                        this._setResizeEvent(),
                                        Ce(document).off(Ie.FOCUSIN),
                                        Ce(this._element).removeClass(Le),
                                        Ce(this._element).off(Ie.CLICK_DISMISS),
                                        Ce(this._dialog).off(
                                            Ie.MOUSEDOWN_DISMISS
                                        ),
                                        n
                        ...
                        (e.dispose = function () {
                            Ce.removeData(this._element, Se),
                                Ce(
                                    window,
                                    document,
                                    this._element,
                        ...
                        (e._showElement = function (e) {
                            ...
                            (this._element.parentNode &&
                                ...
                                i && Rt.reflow(this._element),
                                Ce(this._element).addClass(Le),
                                this._config.focus && this._enforceFocus();
                            var n = Ce.Event(Ie.SHOWN, { relatedTarget: e }),
                                s = function () {
                                    t._config.focus && t._element.focus(),
                                        (t._isTransitioning = !1),
                                        Ce(t._element).trigger(n);
                                };
                            i
                                ? Ce(this._dialog)
                                      .one(Rt.TRANSITION_END, s)
                                      .emulateTransitionEnd(300)
                                : s();
                        }),
                        ...
                        (e._setEscapeEvent = function () {
                            ...
                            this._isShown && this._config.keyboard
                                ...
                                : this._isShown ||
                                  Ce(this._element).off(Ie.KEYDOWN_DISMISS);
                        }),
                        (e._setResizeEvent = function () {
                            var t = this;
                            this._isShown
                                ? Ce(window).on(Ie.RESIZE, function (e) {
                        ...
                        (e._hideModal = function () {
                            ...
                            (this._element.style.display = "none"),
                                ...
                                (this._isTransitioning = !1),
                                this._showBackdrop(function () {
                                    Ce(document.body).removeClass(Ae),
                                        e._resetAdjustments(),
                                        e._resetScrollbar(),
                                        Ce(e._element).trigger(Ie.HIDDEN);
                                });
                        }),
                        (e._removeBackdrop = function () {
                            this._backdrop &&
                                (Ce(this._backdrop).remove(),
                                (this._backdrop = null));
                        }),
                            ...
                            if (this._isShown && this._config.backdrop) {
                                ...
                                if (
                                    ...
                                    (this._backdrop.className =
                                        "modal-backdrop"),
                                    i && Ce(this._backdrop).addClass(i),
                                    ...
                                    n && Rt.reflow(this._backdrop),
                                    Ce(this._backdrop).addClass(Le),
                                    !e)
                                )
                                    return;
                                if (!n) return void e();
                                Ce(this._backdrop)
                                    .one(Rt.TRANSITION_END, e)
                                    .emulateTransitionEnd(150);
                ...
                Ce(document).on(Ie.CLICK_DATA_API, He, function (e) {
                    ...
                    var s = Ce(t).data(Se)
                        ? "toggle"
                        : h({}, Ce(t).data(), Ce(this).data());
                    ("A" !== this.tagName && "AREA" !== this.tagName) ||
                        e.preventDefault();
                    var o = Ce(t).one(Ie.SHOW, function (e) {
                        e.isDefaultPrevented() ||
                            o.one(Ie.HIDDEN, function () {
                                Ce(i).is(":visible") && i.focus();
                            });
                    });
                    Re._jQueryInterface.call(Ce(t), s, this);
                }),
                (Ce.fn.modal = Re._jQueryInterface),
                (Ce.fn.modal.Constructor = Re),
                (Ce.fn.modal.noConflict = function () {
            ...
            Ut =
                ...
                (ke = (function () {
                    ...
                    return (
                        ...
                        (e.toggle = function (e) {
                            if (this._isEnabled)
                                if (e) {
                                    ...
                                    if (le(this.getTipElement()).hasClass(be))
                        ...
                        (e.show = function () {
                            ...
                            if (this.isWithContent() && this._isEnabled) {
                                ...
                                n.setAttribute("id", s),
                                    ...
                                    this.setContent(),
                                    this.config.animation && le(n).addClass(we);
                                var o =
                                        "function" ==
                                ...
                                le(n).data(this.constructor.DATA_KEY, this),
                                    le.contains(
                                        this.element.ownerDocument
                                            .documentElement,
                                        this.tip
                                    ) || le(n).appendTo(a),
                                    le(this.element).trigger(
                                    ...
                                    "ontouchstart" in
                                        ...
                                        le("body")
                                            .children()
                                            .on("mouseover", null, le.noop);
                                var l = function () {
                                    t.config.animation && t._fixTransition();
                                    var e = t._hoverState;
                                    (t._hoverState = null),
                                        le(t.element).trigger(
                                            t.constructor.Event.SHOWN
                                        ),
                                        "out" === e && t._leave(null, t);
                                };
                                Rt.supportsTransitionEnd() &&
                                le(this.tip).hasClass(we)
                                    ? le(this.tip)
                                          .one(Rt.TRANSITION_END, l)
                        ...
                        (e.addAttachmentClass = function (e) {
                            le(this.getTipElement()).addClass(
                                "bs-tooltip-" + e
                            );
                        }),
                        (e.getTipElement = function () {
                            return (
                                (this.tip =
                                    this.tip || le(this.config.template)[0]),
                                this.tip
                            );
                        }),
                        ...
                        (e._enter = function (e, t) {
                            ...
                            (t = t || le(e.currentTarget).data(i)) ||
                                ((t = new this.constructor(
                                    e.currentTarget,
                                    this._getDelegateConfig()
                                )),
                                le(e.currentTarget).data(i, t)),
                                e &&
                                    (t._activeTrigger[
                                        "focusin" === e.type ? Te : _e
                                    ] = !0),
                                le(t.getTipElement()).hasClass(be) ||
                                t._hoverState === ve
                                    ? (t._hoverState = ve)
                ...
                (le.fn[de] = ke._jQueryInterface),
                (le.fn[de].Constructor = ke),
                (le.fn[de].noConflict = function () {
            ...
            Vt =
                ...
                (G.fn[J] = ae._jQueryInterface),
                (G.fn[J].Constructor = ae),
            ...
            Qt =
                ...
                (Z = (function () {
                    function i(e, t) {
                        ...
                        (this._element = e),
                            ...
                            W(this._scrollElement).on(M.SCROLL, function (e) {
                                return i._process(e);
                            }),
                            this.refresh(),
                            this._process();
                    ...
                    return (
                        ...
                        (e.dispose = function () {
                            W.removeData(this._element, F),
                                W(this._scrollElement).off(H),
                                (this._element = null),
                            ...
                            i.hasClass("dropdown-item")
                                ...
                                : (i.addClass(R),
                                  i
                                      ...
                                      .prev(Y + ", " + q)
                                      .addClass(R),
                                  i.parents(B).prev(X).children(Y).addClass(R)),
                                W(this._scrollElement).trigger(M.ACTIVATE, {
                                    relatedTarget: t,
                                });
                        }),
                        (e._clear = function () {
                ...
                (W.fn[L] = Z._jQueryInterface),
                (W.fn[L].Constructor = Z),
                (W.fn[L].noConflict = function () {
                    ...
                    return (
                            ...
                            if (
                                !(
                                    (this._element.parentNode &&
                                        this._element.parentNode.nodeType ===
                                            Node.ELEMENT_NODE &&
                                        k(this._element).hasClass(E)) ||
                                    k(this._element).hasClass("disabled")
                                )
                            ) {
                                var e,
                                    n,
                                    t = k(this._element).closest(
                                        ".nav, .list-group"
                                    )[0],
                                    s = Rt.getSelectorFromElement(
                                        this._element
                                    );
                                if (t) {
                                    var o = "UL" === t.nodeName ? I : D;
                                    n = (n = k.makeArray(k(t).find(o)))[
                                        n.length - 1
                                    ];
                                }
                                var r = k.Event(x.HIDE, {
                                    ...
                                    a = k.Event(x.SHOW, { relatedTarget: n });
                                if (
                                    (n && k(n).trigger(r),
                                    k(this._element).trigger(a),
                                    !a.isDefaultPrevented() &&
                        ...
                        (e._transitionComplete = function (e, t, i) {
                            ...
                            if (
                                ...
                                k(e).addClass("show"),
                                e.parentNode &&
                                    k(e.parentNode).hasClass("dropdown-menu"))
                            ) {
                                var s = k(e).closest(".dropdown")[0];
                                s && k(s).find(".dropdown-toggle").addClass(E),
    ...
    "object" == typeof exports && "undefined" != typeof module
        ? C(exports, require("jquery"), require("popper.js"))
        : "function" == typeof define && define.amd
        ? define(["exports", "jquery", "popper.js"], C)
        : C((k.bootstrap = {}), k.jQuery, k.Popper),
    ...
    (z = (function (n, p, o) {
        ...
        if (
            ((function () {
                ...
                for (e in ((f = n.lazySizesConfig || n.lazysizesConfig || {}),
                t))
                    e in f || (f[e] = t[e]);
            })(),
        ...
        var i,
            ...
            pe = function (e, t) {
                return (
                    he[t] || (he[t] = new RegExp("(\\s|^)" + t + "(\\s|$)")),
                    he[t].test(e[se]("class") || "") && he[t]
                );
            },
            me = function (e, t) {
                pe(e, t) ||
            ...
            be = function (e, t, i) {
                for (
                    i = i || e.offsetWidth;
                    i < f.minSize && t && !e._lazysizesWidth;
            ...
            _e =
                ...
                ((ee = function (e, t) {
                    V && !t
                        ...
                        : (G.push(e), Q || ((Q = !0), (p.hidden ? re : ae)(J)));
                })._lsFlush = J =
                    function () {
                        var e = G;
                        for (G = K.length ? Z : K, Q = !(V = !0); e.length; )
                            e.shift()();
                        V = !1;
                    }),
                ee),
            ...
            Ce =
                ...
                (H = function (e) {
                    return (
                        null == S && (S = "hidden" == we(p.body, "visibility")),
                        S ||
                            !(
                                "hidden" == we(e.parentNode, "visibility") &&
                                "hidden" == we(e, "visibility")
                            )
                    );
                }),
                ($ = function (e, t) {
                    ...
                    for (
                        _ -= t, C += t, T -= t, k += t;
                        s && (n = n.offsetParent) && n != p.body && n != te;

                    )
                        (s = 0 < (we(n, "opacity") || 1)) &&
                            "visible" != we(n, "overflow") &&
                            ...
                            for (t = 0, L++; t < e; t++)
                                if (u[t] && !u[t]._lazyRace)
                                    if (
                                        !I ||
                                        (m.prematureUnveil &&
                                            m.prematureUnveil(u[t]))
                                    )
                                        Y(u[t]);
                                    else if (
                                        (((a = u[t][se]("data-expand")) &&
                                            (o = 1 * a)) ||
                                            (o = A),
                                        d ||
                                            ((d =
                ...
                (N = function (e) {
                    var t,
                        i = e[se](f.srcsetAttr);
                    (t =
                        f.customMedia[e[se]("data-media") || e[se]("media")]) &&
                        e.setAttribute("media", t),
                        i && e.setAttribute("srcset", i);
                }),
                (B = Te(function (t, e, i, n, s) {
                    var o, r, a, l, d, c;
                    (d = ve(t, "lazybeforeunveil", e)).defaultPrevented ||
                        (n &&
                            (i
                                ? me(t, f.autosizesClass)
                        ...
                        (d = { target: t }),
                        me(t, f.loadingClass),
                        c && (clearTimeout(h), (h = re(F, 2500)), ge(t, j, !0)),
                        l && ue.call(a.getElementsByTagName("source"), N),
                        r
                ...
                (Y = function (e) {
                    if (!e._lazyRace) {
                        ...
                        ((!s && v) ||
                            ...
                            pe(e, f.errorClass) ||
                            !pe(e, f.lazyClass)) &&
                            ((t = ve(e, "lazyunveilread").detail),
                            s && Se.updateElem(e, !0, e.offsetWidth),
                            (e._lazyRace = !0),
                            W++,
                            B(e, t, s, n, i));
                    }
                ...
                }),
                {
                    _: function () {
                        (t = o.now()),
                            (m.elements = p.getElementsByClassName(
                                f.lazyClass
                            )),
                            ...
                            n.MutationObserver
                                ? new MutationObserver(P).observe(te, {
                                      childList: !0,
                                      subtree: !0,
                                      attributes: !0,
                                  })
                                : (te[ne]("DOMNodeInserted", P, !0),
                                  te[ne]("DOMAttrModified", P, !0),
                                  setInterval(P, 999)),
                            oe("hashchange", P, !0),
                            [
                                "focus",
                            ...
                            /d$|^c/.test(p.readyState)
                                ? U()
                                : (oe("load", U),
                                  p[ne]("DOMContentLoaded", P),
                                  re(U, 2e4)),
                            m.elements.length ? (O(), _e._lsFlush()) : P();
                    },
                    checkElems: P,
                    unveil: Y,
                    _aLSL: (q = function () {
            ...
            Se =
                ((r = Te(function (e, t, i, n) {
                    ...
                    if (
                        ...
                        for (
                            o = 0,
                                r = (s = t.getElementsByTagName("source"))
                                    .length;
                            o < r;
                            o++
                        )
                ...
                {
                    _: function () {
                        (i = p.getElementsByClassName(f.autosizesClass)),
                            oe("resize", e);
                    },
    ...
    (S.lazySizes = z),
    "object" == typeof module && module.exports && (module.exports = z),
    (x = window),
    (D = function () {
        ...
        e.addEventListener &&
            ...
            (v = function (e, t) {
                ...
                t &&
                    ((i = t.match(n)) && i[1]
                        ...
                        : e.setAttribute("media", p.customMedia[t] || t));
            }),
            (y = function (e) {
                var t, i, n, s;
                e.target._lazybgset &&
            ...
            addEventListener("lazybeforeunveil", function (e) {
                ...
                !e.defaultPrevented &&
                    ...
                    ((d = e.target),
                    ((c = h.createElement("img")).alt = ""),
                    (c._lazybgsetLoading = !0),
                    (e.detail.firesLoad = !0),
                    (i = t),
                    (n = d),
                    (s = c),
                    (o = h.createElement("picture")),
                    ...
                    (i = i.replace(m, " ").split(f)),
                    (o.style.display = "none"),
                    (s.className = p.lazyClass),
                    1 != i.length || r || (r = "auto"),
                    i.forEach(function (e) {
                        var t,
                            i = h.createElement("source");
                        r && "auto" != r && i.setAttribute("sizes", r),
                            (t = e.match(g))
                                ? (i.setAttribute(p.srcsetAttr, t[1]),
                                  v(i, t[2]),
                                  v(i, t[3]))
                                : i.setAttribute(p.srcsetAttr, e),
                            o.appendChild(i);
                    }),
                    r &&
                        (s.setAttribute(p.sizesAttr, r),
                        n.removeAttribute(p.sizesAttr),
                    ...
                    setTimeout(function () {
                        u.loader.unveil(c),
                            u.rAF(function () {
                                u.fire(c, "_lazyloaded", {}, !0, !0),
                                    c.complete && y({ target: c });
                            });
                    }));
            }),
            h.addEventListener("load", y, !0),
            e.addEventListener(
                "lazybeforesizes",
                function (e) {
                    var t, i, n;
            ...
            h.documentElement.addEventListener("lazybeforesizes", function (e) {
                var t, i;
                !e.defaultPrevented &&
                    e.target._lazybgset &&
                    e.detail.instance == u &&
                    (e.detail.width =
                        ...
                        (i = u.gW(t, t.parentNode)),
                        (!t._lazysizesWidth || i > t._lazysizesWidth) &&
                            (t._lazysizesWidth = i),
                        t._lazysizesWidth));
            }));
    }).bind(null, x, x.document)),
    "object" == typeof module && module.exports
        ? E(require("lazysizes"))
        : "function" == typeof define && define.amd
        ? require(["lazysizes"], E)
        : x.lazySizes
        ? D()
        : x.addEventListener("lazyunveilread", D, !0),
    (function (L) {
        "use strict";
        var v = {};
        (v.fileapi = void 0 !== L("<input type='file'/>").get(0).files),
            (v.formdata = void 0 !== window.FormData);
        var F = !!L.fn.prop;
        function i(e) {
            var t = e.data;
            e.isDefaultPrevented() ||
                (e.preventDefault(), L(this).ajaxSubmit(t));
        }
        function n(e) {
            var t = e.target,
                i = L(t);
            ...
            if ("image" == (s.clk = t).type)
                if (void 0 !== e.offsetX)
                    ...
                    (s.clk_x = e.pageX - t.offsetLeft),
                        (s.clk_y = e.pageY - t.offsetTop);
            setTimeout(function () {
        ...
        (L.fn.attr2 = function () {
            ...
            (L.fn.ajaxSubmit = function (D) {
                ...
                var I,
                    ...
                    t,
                    A = this;
                "function" == typeof D && (D = { success: D }),
                    (I = this.attr2("method")),
                    (t =
                        (t =
                            "string" == typeof (e = this.attr2("action"))
                                ? L.trim(e)
                                : "") ||
                ...
                var i = {};
                if ((this.trigger("form-pre-serialize", [this, D, i]), i.veto))
                    return (
                        H(
                ...
                if (
                    (D.data &&
                        ((D.extraData = D.data), (s = L.param(D.data, n))),
                    D.beforeSubmit && !1 === D.beforeSubmit(o, this, D))
                )
                    return (
                        H(
                ...
                if (
                    (this.trigger("form-submit-validate", [o, this, D, i]),
                    i.veto)
                )
                    return (
                        H(
                ...
                D.success = function (e, t, i) {
                    for (
                        var n = D.context || this, s = 0, o = a.length;
                        s < o;
                        s++
                    )
                        a[s].apply(n, [e, t, i || A, A]);
                };
                var d =
                        0 <
                        L('input[type=file]:enabled[value!=""]', this).length,
                ...
                var p,
                    m = (d || h) && !u;
                !1 !== D.iframe && (D.iframe || m)
                    ? D.closeKeepAlive
                        ? L.get(D.closeKeepAlive, function () {
                              p = g(o);
                          })
                        : (p = g(o))
                    : (p =
                          (d || h) && u
                              ...
                              : L.ajax(D)),
                    A.removeData("jqxhr").data("jqxhr", p);
                ...
                function g(e) {
                    ...
                    if (
                        (((c = L.extend(!0, {}, L.ajaxSettings, D)).context =
                            c.context || c),
                        (s = "jqFormIO" + new Date().getTime()),
                        c.iframeTarget
                            ? (o = (u = L(c.iframeTarget)).attr2("name"))
                                ? (s = o)
                                : u.attr2("name", s)
                            : (u = L(
                                  '<iframe name="' +
                        ...
                        (m = {
                            ...
                            abort: function (e) {
                                ...
                                u.attr("src", c.iframeSrc),
                                    (m.error = t),
                                    c.error && c.error.call(c.context, m, t, e),
                                    h &&
                                        L.event.trigger("ajaxError", [m, c, t]),
                                    c.complete &&
                                        c.complete.call(c.context, m, t);
                            },
                        }),
                        (h = c.global) &&
                            0 == L.active++ &&
                            L.event.trigger("ajaxStart"),
                        h && L.event.trigger("ajaxSend", [m, c]),
                        c.beforeSend &&
                            !1 === c.beforeSend.call(c.context, m, c))
                    )
                    ...
                    (n = r.clk) &&
                        ...
                        (c.extraData[o] = n.value),
                        "image" == n.type &&
                            ((c.extraData[o + ".x"] = r.clk_x),
                            (c.extraData[o + ".y"] = r.clk_y)));
                    var y = 1,
                        w = 2;
                    function b(t) {
                        var i = null;
                        ...
                        try {
                            ...
                            H("cannot get iframe.contentDocument: " + e),
                                (i = t.document);
                        }
                        return i;
                    }
                    ...
                    function d() {
                        ...
                        r.setAttribute("target", s),
                            I || r.setAttribute("method", "POST"),
                            t != c.url && r.setAttribute("action", c.url),
                    ...
                    function S(e) {
                        if (!m.aborted && !k) {
                            if (
                                ((T = b(p)) ||
                                    (H("cannot access response document"),
                                    (e = w)),
                                e === y && m)
                            )
                                return (
                                    m.abort("timeout"),
                                    void v.reject(m, "timeout")
                                );
                            if (e == w && m)
                                return (
                                    m.abort("server abort"),
                                    void v.reject(m, "error", "server abort")
                                );
                            if ((T && T.location.href != c.iframeSrc) || f) {
                                ...
                                try {
                                    ...
                                    if (r || c.textarea) {
                                        ...
                                        "xml" == o &&
                                            !m.responseXML &&
                                            m.responseText &&
                                            (m.responseXML = z(m.responseText));
                                    try {
                                        _ = E(m, o, c);
                                    } catch (e) {
                                        (i = "parsererror"),
                                ...
                                m.aborted && (H("upload aborted"), (i = null)),
                                    m.status &&
                                        (i =
                                            (200 <= m.status &&
                                                m.status < 300) ||
                                    ...
                                    "success" === i
                                        ...
                                        : i &&
                                          ...
                                          c.error &&
                                              c.error.call(c.context, m, i, t),
                                          v.reject(m, "error", t),
                                          h &&
                                              L.event.trigger("ajaxError", [
                                                  m,
                                                  c,
                                                  t,
                                              ])),
                                    h &&
                                        L.event.trigger("ajaxComplete", [m, c]),
                                    h &&
                                        !--L.active &&
                                        L.event.trigger("ajaxStop"),
                                    c.complete &&
                                        c.complete.call(c.context, m, i),
                                    (k = !0),
            ...
            (L.fn.ajaxForm = function (e) {
                if (
                    (((e = e || {}).delegation =
                        e.delegation && L.isFunction(L.fn.on)),
                    ...
                    return e.delegation
                        ? (L(document)
                              ...
                              .on("click.form-plugin", this.selector, e, n),
                          this)
                        : this.ajaxFormUnbind()
                              .bind("submit.form-plugin", e, i)
                              .bind("click.form-plugin", e, n);
                var t = { s: this.selector, c: this.context };
                return (
                    !L.isReady && t.s
                        ? (H("DOM not ready, queuing ajaxForm"),
                          L(function () {
                    ...
                    if ((o = (a = h[n]).name) && !a.disabled)
                        if (e && c.clk && "image" == a.type)
                            c.clk == a &&
                                ...
                                i.push(
                                    { name: o + ".x", value: c.clk_x },
                                    { name: o + ".y", value: c.clk_y }
                                ));
                        else if (
                            (r = L.fieldValue(a, !0)) &&
                            r.constructor == Array
                            ...
                            for (
                                t && t.push(a), s = 0, d = r.length;
                                s < d;
                                s++
                            )
                                i.push({ name: o, value: r[s] });
            ...
            (L.fn.fieldValue = function (e) {
                for (var t = [], i = 0, n = this.length; i < n; i++) {
                    ...
                    null == o ||
                        ...
                        (o.constructor == Array ? L.merge(t, o) : t.push(o));
                }
                return t;
            }),
    ...
    (A = jQuery).extend(A.fn, {
                        ...
                        (this.validateDelegate(
                            ...
                            function (e) {
                                i.settings.submitHandler &&
                                    ...
                                    A(e.target).hasClass("cancel") &&
                                        (i.cancelSubmit = !0),
                                    void 0 !==
                                        A(e.target).attr("formnovalidate") &&
                                        (i.cancelSubmit = !0);
                            }
                        ),
                        this.submit(function (t) {
                            function e() {
                                ...
                                return (
                                    !i.settings.submitHandler ||
                                    (i.submitButton &&
                                        (e = A("<input type='hidden'/>")
                                            .attr("name", i.submitButton.name)
                                            .val(A(i.submitButton).val())
        ...
        rules: function (e, t) {
            ...
            if (e) {
                ...
                switch (e) {
                    case "add":
                        A.extend(o, A.validator.normalizeRule(t)),
                            delete o.messages,
                            (s[i.name] = o),
                            t.messages &&
                                (n.messages[i.name] = A.extend(
                                    n.messages[i.name],
                                    t.messages
                                ));
                        break;
            ...
            var a = A.validator.normalizeRules(
                A.extend(
                    {},
                    A.validator.classRules(i),
                    A.validator.attributeRules(i),
                    A.validator.dataRules(i),
    ...
    (A.validator.format = function (i, e) {
        return 1 === arguments.length
            ...
            : (2 < arguments.length &&
                  e.constructor !== Array &&
                  (e = A.makeArray(arguments).slice(1)),
    ...
    A.extend(A.validator, {
        defaults: {
            ...
            highlight: function (e, t, i) {
                "radio" === e.type
                    ...
                    : A(e).addClass(t).removeClass(i);
            },
            unhighlight: function (e, t, i) {
                "radio" === e.type
                    ? this.findByName(e.name).removeClass(t).addClass(i)
                    : A(e).removeClass(t).addClass(i);
            },
        },
        ...
        prototype: {
            ...
            showErrors: function (t) {
                if (t) {
                    for (var e in (A.extend(this.errorMap, t),
                    (this.errorList = []),
                    t))
                        this.errorList.push({
                            message: t[e],
            ...
            elementValue: function (e) {
                var t = A(e).attr("type"),
                    i = A(e).val();
                return "radio" === t || "checkbox" === t
                    ? A("input[name='" + A(e).attr("name") + "']:checked").val()
                    : "string" == typeof i
                    ? i.replace(/\r/g, "")
                    : i;
            },
            ...
            customDataMessage: function (e, t) {
                return (
                    A(e).data("msg-" + t.toLowerCase()) ||
                    (e.attributes && A(e).attr("data-msg-" + t.toLowerCase()))
                );
            },
                    ...
                    : ((i = A("<" + this.settings.errorElement + ">")
                      ...
                      this.labelContainer.append(i).length ||
                          (this.settings.errorPlacement
                              ? this.settings.errorPlacement(i, A(e))
                              : i.insertAfter(e))),
                    !t &&
                        this.settings.success &&
                        (i.text(""),
            ...
            optional: function (e) {
                ...
                return (
                    !A.validator.methods.required.call(this, t, e) &&
                    "dependency-mismatch"
                );
            },
        ...
        addClassRules: function (e, t) {
            e.constructor === String
                ...
                : A.extend(this.classRuleSettings, e);
        },
                ...
                i &&
                    A.each(i.split(" "), function () {
                        this in A.validator.classRuleSettings &&
                            A.extend(t, A.validator.classRuleSettings[this]);
                    }),
                t
            );
        },
        ...
        dataRules: function (e) {
            var t,
                ...
                n = {},
                s = A(e);
            for (t in A.validator.methods)
                void 0 !== (i = s.data("rule-" + t.toLowerCase())) &&
                    (n[t] = i);
            return n;
        },
        staticRules: function (e) {
            ...
            return (
                i.settings.rules &&
                    (t =
                        A.validator.normalizeRule(i.settings.rules[e.name]) ||
                        {}),
                t
            );
        },
        ...
        addMethod: function (e, t, i) {
            (A.validator.methods[e] = t),
                (A.validator.messages[e] =
                    void 0 !== i ? i : A.validator.messages[e]),
                t.length < 3 &&
                    A.validator.addClassRules(e, A.validator.normalizeRule(e));
        },
        methods: {
            ...
            date: function (e, t) {
                return (
                    this.optional(t) || !/Invalid|NaN/.test("" + new Date(e))
                );
            },
                    ...
                    A.ajax(
                        A.extend(
                            !0,
                            {
                                ...
                                data: t,
                                success: function (e) {
                                    l.settings.messages[r.name].remote =
                                        a.originalMessage;
                                    var t = !0 === e || "true" === e;
                                    if (t) {
                                        ...
                                        var n = {},
                                            s =
                                                e ||
                                                l.defaultMessage(r, "remote");
                                        (n[r.name] = a.message =
                                            A.isFunction(s) ? s(o) : s),
                                            (l.invalid[r.name] = !0),
                                            l.showErrors(n);
                                    }
    ...
    (L = {
        init: function (e) {
            return this.each(function () {
                ...
                t.find(".tt-item__content").slideToggle(100),
                    i.on("click", function () {
                        W(this).parent().hasClass("tt-item__open") ||
                            W(this)
                                .parent()
                                .siblings()
    ...
    (W.fn.accordeon = function (e) {
        return L[e]
            ...
            : "object" != typeof e && e
            ? (console.info("Action " + e + "not found this plugin"), this)
            : L.init.apply(this, arguments);
    }),
    W("#tt-pageContent .js-accordeon").accordeon(),
    (F = jQuery),
    (H = F("#js-backtotop")),
    (O = F(window)),
    H.length &&
        ...
        O.scroll(function () {
            500 < O.scrollTop()
                ? H.stop((!0).false).addClass("pt-show")
                : H.stop((!0).false).removeClass("pt-show");
        })),
    (function (e) {
        var t,
            i,
        ...
        ("ontouchstart" in window || "onmsgesturechange" in window) &&
            n.addClass("touch-device"),
            /Edge/.test(navigator.userAgent) && n.addClass("edge");
    })(),
    (function (t) {
        var i = t("#tt-nav");
        if (!i.length) return;
            ...
            i.find("li").each(function () {
                ...
                n == e &&
                    (t(this)
                        ...
                        .closest(".subMenu")
                        .addClass("active"),
                    i.addClass("defined-item"));
            }),
            i.hasClass("defined-item") ||
                i.find("> ul > li:first-child").addClass("active"),
    ...
    (function (i) {
        ...
        i("body").on(
            ...
            function (e) {
                if (
                    (e.preventDefault(),
                    i(this).closest(".js-dropdown-cart").hasClass("active"))
                )
                    return n(), !1;
                i.ajax({
    ...
    (function (i) {
        ...
        var e;
        (e = n.find(".active a").attr("href")),
            s.find("." + e).addClass("show");
        i("body").on(
            "click touchstart",
            ...
            function (e) {
                if (
                    (e.preventDefault(),
                    i(this).closest("li").hasClass("active"))
                )
                    return !1;
                i(this)
                    .closest("li")
 ...
 (function (i1) {
        ...
        i1("body").on(
            "click touchstart",
            "#filter-nav1 .gallery-navitem",
            function (e) {
                if (
                    (e.preventDefault(),
                    i1(this).closest("li").hasClass("active"))
                )
                    return !1;
                i1(this)
                    .closest("li")
            ...
            s("body").on(
                ...
                function (e) {
                    var t,
                        ...
                        n = s(this);
                    return (
                        s(this).closest(".tt-slideinfo").hasClass("open-info")
                            ? ((i = n).html("+"),
                              i
                            ...
                            : ((t = n).html("-"),
                              t
                                  ...
                                  .find(".tt-item__btn  > *")
                                  .html("+"),
                              t.closest(".tt-slideinfo").addClass("open-info")),
                        !1
                    );
                }
            );
    ...
    (function (e) {
        ...
        e("#modalMakeAppointment .js_datepicker-1")
            .datepicker({ language: "en" })
            .data("datepicker"),
            e("#orderform .datepicker-1")
                .datepicker({ language: "en" })
                .data("datepicker");
    })(jQuery),
    (function (e) {
        ...
        if (t && i) {
            ...
            e("#mobile-menu").find("ul").append(n),
                i.initMM({
                    enable_breakpoint: !0,
                    mobile_button: !0,
                    breakpoint: 1025,
    ...
    (P = jQuery),
    (M = P("#tt-pageContent .js-video-popup")).length &&
        M.each(function () {
    ...
    (function (r) {
        function t() {
            if ((window.innerWidth || r(window).width()) <= 786)
                return (
                    r("#tt-pageContent .layout01").each(function () {
                        r(this)
                            .find(".layout01__content-wrapper")
                            .removeAttr("style");
                    }),
                    !1
                );
    ...
    (function (r) {
        ...
        n.mainSlider.length &&
            ...
            (t = "[data-bgslide]"),
            n.mainSlider.find(t).each(function () {
                var e = r(this),
...
!(function (a) {
        ...
        }),
        {
            ...
            init: function (e) {
                var t = this,
                    ...
                    s = t.thumb_parent;
                if (
                    (t.initBigGalleryButtons(), t.scrollSlider(), 0 == n.length)
                )
                    return !1;
                if (!t.checkNoZoom()) {
                    var o = n.parent().parent().attr("data-scrollzoom");
                    (o = o || t.scroll_zoom),
                        (t.scroll_zoom = "false" != o),
                        575 < i && t.configureZoomImage(),
                        t.resize();
                }
                if (0 == s.length) return !1;
                t[
                    -1 < s.parent().attr("class").indexOf("-vertical")
                        ? "vertical"
                        : "horizontal"
                ](s),
                    t.setBigImage(s);
            ...
            configureZoomImage: function () {
                ...
                a(".zoomContainer").remove(),
                    a(this.class_name).each(function () {
                        var e = a(this),
            ...
            resize: function () {
                ...
                a(window).resize(function () {
                    if ((window.innerWidth || a(window).width()) <= 575)
                        return !1;
            ...
            setBigImage: function (o) {
                ...
                o.find("a").on("click", function (e) {
                    ...
                    o
                        ...
                        a(this).addClass("zoomGalleryActive");
                });
            },
        }.init();
    var t = a(".tt-input-counter");
    t.length &&
        (t.find(".minus-btn, .plus-btn").on("click", function (e) {
            var t = a(this).parent().find("input"),
                i =
                    parseInt(t.val(), 10) +
                    parseInt(
                        "plus-btn" === e.currentTarget.className ? 1 : -1,
                        10
                    );
            t.val(i).change();
        }),
    ...
    (function (n) {
        ...
        if (s.length && s.length) {
            function l(e) {
                ...
                return (
                    s.removeClass("tt-open-col"),
                    r.removeAttr("style").removeClass("no-scroll").scrollTop(t),
                    a.removeAttr("style").scrollTop(t),
                    n("#modal-filter").off().remove(),
                    !1
                );
            }
            n("body").on("click", "#js-filters-toggle", function (e) {
                n(this).hasClass("tt-open-col")
                    ? l()
                    : (function (e) {
                          s.addClass("tt-open-col");
                          var t = r.scrollTop() || a.scrollTop();
                          o.addClass("column-open").perfectScrollbar(),
                              r
                                  .css("top", -t)
                                  .addClass("no-scroll")
                                  .append('<div id="modal-filter"></div>');
    ...
    (window.onload = function () {
        ...
        window.onscroll = function () {
            ...
            t.top
                ? (e.classList.add("fixed"), i && i.classList.add("fixed"))
                : (e.classList.remove("fixed"),
                  i && i.classList.remove("fixed"));
        };
    }),
    (function (e) {
        var t = e("#tt-header"),
